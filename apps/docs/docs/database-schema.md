...
- **Provider credentials** (API token, PAT): dienkripsi dengan **AES-256-GCM** sebelum disimpan
- **Environment variables**: semua value dienkripsi at rest
- **Secret variables** (`isSecret: true`): di-mask sebagai `***` di API response
