  ...
  const coreFeatures: FeatureCardProps[] = [
    {
      ...
      description:
        'Understand the underlying architecture, Turborepo setup, NestJS modules, and data flow.',
      icon: '🏗️',
    ...
    },
    {
      ...
      description:
        'Step-by-step guide to deploying the platform, configuring docker-compose, and reverse proxy settings.',
      icon: '🚀',
    ...
    },
    {
      ...
      description:
        'Configure and link GitHub for repository sync and Coolify for deployment controls.',
      icon: '🔌',
    ...
    },
    {
      ...
      description:
        'Explore the complete Prisma schema including models for Users, Deployments, and Monitoring.',
      icon: '🗄️',
    ...
    },
    {
      ...
      description:
        'Understand BullMQ processor jobs for sync tasks and deployments status polling.',
      icon: '🔄',
    ...
    },
    {
      ...
      description:
        'Track the completed features and upcoming roadmap for versions v0.2, v0.3, and v1.0.',
      icon: '🗺️',
      link: '/docs/roadmap',
    },
  ];
      ...
      <main className="homepage-main">
        <div className="container">
          <div className="homepage-section-header">
            ...
            <p>
              Select a section below to learn more about the structure, modules, and deployment of
              HALLO Projects.
            </p>
          </div>
